    ...
    return (
        <div className="flex flex-col sm:flex-row justify-between items-center pb-4 border-b border-gray-200">
            ...
            <button
                ...
                className="mt-4 sm:mt-0 w-full sm:w-auto flex items-center justify-center bg-blue-600 text-white font-medium py-2 px-4 rounded-md hover:bg-blue-700 transition-colors"
            >
