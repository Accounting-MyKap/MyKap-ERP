// pages/templates/documentTemplates.ts

/**
 * LEGAL DISCLAIMER: The following document templates are provided for illustrative purposes only.
 * They are not a substitute for professional legal advice. Always consult with a qualified
 * attorney to ensure any legal document is appropriate for your specific circumstances
 * and complies with all applicable laws.
 */

// Centralized configuration for details used across templates
export const COMPANY_CONFIG = {
    name: "Home Kapital Finance, LLC",
    legalStructure: "a Florida Limited Liability Company",
    address: "1555 Bonaventure Blvd, Suite 2015, Weston, FL 33326"
};
...
If to the Lender: ${COMPANY_CONFIG.name}, ${COMPANY_CONFIG.legalStructure}, ${COMPANY_CONFIG.address}
...
Approved by the Lender : ${COMPANY_CONFIG.name}, ${COMPANY_CONFIG.legalStructure},

Date: _________________________
Diego Felipe Quesada, Member

Signature Page to Secured Promissory Note
Note #: {{BORROWER_NAME}} to ${COMPANY_CONFIG.name}
`;
...
export const getReadOnlyDefaultTemplates = () => [
